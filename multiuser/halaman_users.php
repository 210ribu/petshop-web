...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3">PETSHOP USERS</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">Form Add</div>
                            <a class="nav-link" href="../adduser/formadd.php">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3"><p>Halo <?php echo $_SESSION['username']; ?> Anda telah login sebagai <?php echo $_SESSION['level']; ?>.</p>
                                ...
                                Silahkan Beli Barang Yang Anda Inginkan Dan Hubungi Kasir Untuk Melakukan Pembayaran : 
                            </div>
